...
public class ReviewStatsService {
    ...
    public ReviewStatsResponse stats(UUID userId,
        ...
        QueryWindow window = normalizeWindow(now, userDeckId, fromDate, toDate, timeZone, dayCutoffMinutes, forecastDays);
    ...
    private record QueryWindow(
        ...
        Instant reviewDayEndInstant(Instant now) {
            LocalDate day = reviewDayDate(now, timeZone, dayCutoffMinutes);
