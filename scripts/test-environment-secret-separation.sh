...
keys='AUTH_JWT_PUBLIC_KEY AUTH_JWT_PRIVATE_KEY TURNSTILE_SECRET_KEY GOOGLE_CLIENT_SECRET GITHUB_CLIENT_SECRET YANDEX_CLIENT_SECRET POSTGRES_PASSWORD AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY AWS_BUCKET_NAME MEDIA_INTERNAL_TOKEN CORE_INTERNAL_TOKEN USER_INTERNAL_TOKEN'
for key in $keys; do
...
keys = "AUTH_JWT_PUBLIC_KEY AUTH_JWT_PRIVATE_KEY TURNSTILE_SECRET_KEY GOOGLE_CLIENT_SECRET GITHUB_CLIENT_SECRET YANDEX_CLIENT_SECRET POSTGRES_PASSWORD AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY AWS_BUCKET_NAME MEDIA_INTERNAL_TOKEN CORE_INTERNAL_TOKEN USER_INTERNAL_TOKEN".split()
