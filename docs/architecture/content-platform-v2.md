...
storage, private content/authoring contracts, bounded Study session snapshots,
deterministic attempts and baseline scheduling state; progress and remaining P0
adapters remain in progress and the
