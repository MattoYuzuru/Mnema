...
const translations: Record<Language, Translations> = {
    en: {
        ...
        'cardBrowser.keyboardHint': 'Space flips the card; Left/Right arrows navigate',
    ...
    ru: {
        ...
        'cardBrowser.keyboardHint': 'Пробел переворачивает карточку; Стрелки влево/вправо навигация',
